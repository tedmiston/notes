...
- starting / joining a startup is the best way to get rich
...
- "the beneficiary of one of the most spectacular blunders in the history of business: the licensing deal for DOS"
...
- "And so it's clearer to programmers that wealth is something that's made, rather than being distributed"
...
- "Hackers often donate their work by writing open source software"
...
- "When John Smith finishes school he is expected to get a job. And what getting a job seems to mean is joining another institution."
...
- "It turns out, though, that there are economies of scale in how much of your life you devote to your work."
...
- "Unfortunately, companies can't pay everyone like salesmen. Salesmen work alone. Most employees' work is tangled together."
...
- "CEOs also have both measurement and leverage. They're measured, in that the performance of the company is their performance."
- "I think every one who gets rich by their own efforts will be found to be in a situation with measurement and leverage."
...
- "The leading edge of technology moves fast. Technology that's valuable today could be worthless in a couple years."
- "Also, technical advances tend to come from unorthodox approaches, and small companies are less constrained by convention."
- "Big companies can develop technology. They just can't do it quickly."
- "So in practice big companies only get to develop technology in fields where large capital requirements prevent startups from competing"
...
- "Via web's hackers were all extremely risk-averse."
...
- "It would have been a bargain to buy us at an early stage, but companies doing acquisitions are not looking for bargains. A company big enough to acquire startups will be big enough to be fairly conservative"
- "They would rather overpay for a safe choice. So it is easier to sell an established startup, even at a large premium, than an early-stage one."
...
- "Treat a startup as an optimization problem in which performance is measured by number of users. As anyone who has tried to optimize software knows, the key is measurement."
...
- "Two things changed. The first was the rule of law. For most of the world's history, if you did somehow accumulate a fortune, the ruler or his henchmen would find a way to steal it."
- "So for the first time in our history, the bullies stopped stealing the nerds' lunch money."
- "the second big change, industrialization"
