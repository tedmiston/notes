...
- sam started loopt at 19
- loopt grew out of a project he was building and morphed into one only because of yc
- his dormmate blake ross told sam about pg's summer founders program announcement on the day applications were due
- he know who pg was but was't "following startups" in 2005
...
- he worked in the stanford cs research lab the summer before on autonomous helicopter navigation project that used gps, before thinking about gps was a common thing
- palm treo's were the best "smartphone" at the time
...
- good entrepreneurs are often particularly sensitive to rejection / care too much about what others think
- especially first-time founders are extremely insecure about this
...
- dealing with both (1) insanely personal ad hominem attacks, and (2) business challenges - no one knows about your product and you have to push through until they start discovering it
- ben silverman when he was working on early versions of pinterest used to walk around cafes in palo alto and ask people to try his product; and go in the apple store and set all the browsers to pinterest.com before employees see it and maybe some people really fall in love with the product
...
- a few weeks ago they talked about tech being applied into legacy industries to transform the way they work... is it really infiltrating more industries or are we just seeing that in a couple places that people are talking about a lot?  "it's hard to see an exponential curve when you're on one -- if you back they look flat, and if you look forward they look vertical, but i think it's just the continuing compounding curve"
...
- founder of ridecell: on-demand access to shared ride services by partnering with transit agencies
- originally launched from georgia tech
- why?
- most large transportation systems are fairly inefficient (farebox recovery ratio = how much money they make for every dollar they invest), and it's below 20% for many U.S. systems because they're hard to use
- reasons:
  1. poor tools - lots done manually vs. automation, 30-year-old software, can't do anything in realtime
  2. poor data - they don't know where things aren't working, where/why people aren't using transit (particularly in realtime)
  3. misallocation of demand and supply - ex. "in LA there is a bus that runs once an hour, but costs $125/hr to run, no one rides it because it runs once an hour, but because no one rides it they can't run it more frequently"
- low frequency of transit makes it hard for people to get to trains and subways in many cities if they live more than a mile or so from the train station because it's easier to just drive to work
- their software is an operating system for transit agencies to find where the problems are, automate manual tasks, and augment/replace empty bus routes with on-demand shared ride services that are more flexible
- these agencies could be great with the right information
- but... how did you end up doing this?
- he became a programmer out of the immediate satisfaction for creating something and being able to see it work instantly
- after learning to drive in mumbai, he failed the atlanta driving test several times, and has to take the transit system
- how did you figure out where to start?
- i found a CS professor at georgia tech that had worked on transit for a while. he has this grand notion of how you fix the integrated transit problem, and so he started attacking the large problem, which is a bad idea.
- "the right approach is to find the smallest bit of the problem that you can solve today"
- i started the wrong way by launching a consumer transportation service that competed with uber, then coming back to these transit agencies to show what we learned
- what lessons did you learn trying to compete with uber that you brought back to the agencies?
  1. figuring out the structural lesson of where the root causes lies and attacking it: focus on matching supply and demand - the hard part about running uber is the backend.  a lot of programmers like building tools for transit, but they're mostly focusing on the front end of the problem
...
- figuring out which parts of the system should be fixed schedule vs. which should be dynamic because of demand
- what did you say when you went back to the transit agencies that you could solve all of their problems in one swoop or by focusing on giving them one thing first?
- the latter -- they wanted apps, but only so much could be done with the underlying system being  inefficient, so we went back to solve the core problem: efficiency & cost (thereby improving user experience and apps)
...
- 4 of the top 10 transit agencies in the u.s. are starting a pilot with us, and we have pilots running.  we understand this problem better than anyone else in the world, so now the real challenge is just bandwidth.
